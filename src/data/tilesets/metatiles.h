...
const u16 gMetatiles_PoryTilesPrimary[] = INCBIN_U16("data/tilesets/primary/pory_tiles_primary/metatiles.bin");
const u16 gMetatileAttributes_PoryTilesPrimary[] = INCBIN_U16("data/tilesets/primary/pory_tiles_primary/metatile_attributes.bin");
